...
impl Plugin for ShaderPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ...
            ExtractComponentPlugin::<ShaderPostProcessSettings>::default(),
            // The settings will also be the data used in the shader.
            // This plugin will prepare the component for the GPU by creating a uniform buffer
            // and writing the data to that buffer every frame.
            UniformComponentPlugin::<ShaderPostProcessSettings>::default(),
        ))
    ...
    fn finish(&self, app: &mut App) {
        ...
        render_app
            ...
            .init_resource::<ShaderPostProcessPipeline>();
    }
}

/// The post process node used for the render graph
struct ShaderPostProcessNode {
...
struct ShaderPostProcessLabel;

impl FromWorld for ShaderPostProcessNode {
...
impl Node for ShaderPostProcessNode {
    ...
    fn run(
        ...
        let post_process_pipeline = world.resource::<ShaderPostProcessPipeline>();
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<ShaderPostProcessSettings>>();
...
#[derive(Resource)]
struct ShaderPostProcessPipeline {
    layout: BindGroupLayout,
    sampler: Sampler,
    pipeline_id: CachedRenderPipelineId,
}

impl FromWorld for ShaderPostProcessPipeline {
    fn from_world(world: &mut World) -> Self {
...
struct ShaderPostProcessSettings {
    time: f32,
    _wasm_padding: Vec3,
}
...
fn update_time(mut settings: Query<&mut ShaderPostProcessSettings>) {
